...
export const uiStrings = {
  ...
  errorLoadingShifts: "Could not load your shifts. Please ensure your profile is complete or contact support.",
  taxi: "Taxi",
  date: "Date",
  ...
  errorLoadingTaxis: "Could not load taxi data. Please try again.",
  // Taxi Booking Modal
  ...
  endTimeAfterStartTime: "End time must be after start time. For overnight shifts, the end time can be on the next calendar day.",
  ...
  errorLoadingDriverData: "Could not load driver data. Ensure you are an admin and have permissions.",
  driverName: "Name",
  ...
  errorAddingDriver: "Could not add driver. Please check the details and try again.",
  errorUpdatingDriver: "Could not update driver. Please try again.",
  ...
  errorDeletingDriverAndShifts: "Error deleting driver profile and/or associated shifts. Please check permissions.",
  ...
  errorLoadingTaxisAdmin: "Could not load taxi data. Ensure you are an admin and have permissions.",
  ...
  errorAddingTaxi: "Could not add taxi. Please check details and permissions.",
  errorUpdatingTaxi: "Could not update taxi. Please check details and permissions.",
  ...
  errorLoadingAllShifts: "Could not load shifts data. Ensure you are an admin and have permissions.",
  ...
  errorLoadingShiftDistribution: "Could not load shift distribution data. Please check admin permissions.",
  errorLoadingTaxiUtilization: "Could not load taxi utilization data. Please check admin permissions.",
  errorLoadingShiftsOverTime: "Could not load shifts over time data. Please check admin permissions.",
...
export const translations: Record<Locale, Partial<typeof uiStrings>> = {
  ...
  de: {
    ...
    errorLoadingShifts: "Ihre Schichten konnten nicht geladen werden. Bitte stellen Sie sicher, dass Ihr Profil vollständig ist oder kontaktieren Sie den Support.",
    taxi: "Taxi",
    date: "Datum",
    startTime: "Startzeit",
    endTime: "Endzeit",
    ...
    errorLoadingTaxis: "Taxidaten konnten nicht geladen werden. Bitte versuchen Sie es erneut.",
    // Taxi Booking Modal
    ...
    endTimeAfterStartTime: "Die Endzeit muss nach der Startzeit liegen. Bei Nachtschichten kann die Endzeit am nächsten Kalendertag liegen.",
    ...
    errorLoadingDriverData: "Fahrerdaten konnten nicht geladen werden. Stellen Sie sicher, dass Sie Admin sind und über Berechtigungen verfügen.",
    driverName: "Name",
    ...
    errorAddingDriver: "Fahrer konnte nicht hinzugefügt werden. Bitte überprüfen Sie die Angaben und versuchen Sie es erneut.",
    errorUpdatingDriver: "Fahrer konnte nicht aktualisiert werden. Bitte versuchen Sie es erneut.",
    ...
    errorDeletingDriverAndShifts: "Fehler beim Löschen des Fahrerprofils und/oder der zugehörigen Schichten. Bitte Berechtigungen prüfen.",
    ...
    errorLoadingTaxisAdmin: "Taxidaten konnten nicht geladen werden. Stellen Sie sicher, dass Sie Admin sind und über Berechtigungen verfügen.",
    ...
    errorAddingTaxi: "Taxi konnte nicht hinzugefügt werden. Bitte Details und Berechtigungen prüfen.",
    errorUpdatingTaxi: "Taxi konnte nicht aktualisiert werden. Bitte Details und Berechtigungen prüfen.",
    ...
    errorLoadingAllShifts: "Schichtdaten konnten nicht geladen werden. Stellen Sie sicher, dass Sie Admin sind und über Berechtigungen verfügen.",
    ...
    errorLoadingShiftDistribution: "Verteilung der Schichten konnte nicht geladen werden. Bitte Admin-Berechtigungen prüfen.",
    errorLoadingTaxiUtilization: "Taxiauslastung konnte nicht geladen werden. Bitte Admin-Berechtigungen prüfen.",
    errorLoadingShiftsOverTime: "Schichten im Zeitverlauf konnten nicht geladen werden. Bitte Admin-Berechtigungen prüfen.",
    // Employee Types
