...
export const uiStrings = {
  ...
  selectDates: "Date(s)",
  shiftBookedSuccessfully: "Shift(s) booked successfully.",
  ...
  deleteShiftAdminConfirmation: "This will permanently delete the shift for {driverName} on taxi {taxiLicensePlate} ({dateTime}). This action cannot be undone.",
...
export const translations: Record<Locale, typeof uiStrings> = {
  ...
  de: {
    ...
    shiftBookedSuccessfully: "Schicht(en) erfolgreich gebucht.",
